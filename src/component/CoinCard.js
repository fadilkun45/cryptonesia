    ...
    return (
        <Link to={'/detail/' + id} className="coins hover:bg-green-700 transition duration-150 bg-green-600 mb-1 px-4 py-3 w-full flex items-center justify-between px-3 py-2 my-2 text-center">
            <div className="w-1/6 flex justify-between items-center">
                <div className="w-1/6">
                <p className="text-xl text-white font-semibold ">{rank}</p>
                </div>
                <div className="w-4/6 flex justify-items-start">
            ...
            <div className="w-2/6 flex">
                ...
                <div className="w-2/6">
                <p className="text-xs lg:text-sm text-white font-semibold">{symbol}</p>
                </div>
                <div className="w-2/6">
