...
const News = () => {
    ...
    return (
        <div className="container mx-auto mt-5 mb-20 md:mb-0 px-4  py-5">
           <div className="md:w-5/6 bg-green-500 mx-auto px-4 py-5 rounded-md">
        ...
        {/* filter */}
          <div className="flex flex-col rounded-md bg-green-500 px-4 py-5 text-white items-center md:w-5/6 mx-auto mt-6  ">
        ...
        <div className="flex mx-auto md:w-5/6 flex-wrap mt-6 bg-green-500 px-4 py-3 text-white flex-col ">
            {
                isFetching && <div className="w-5/6 mx-auto">
